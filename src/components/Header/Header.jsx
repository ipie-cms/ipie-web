...
import RegisterModal from '../RegisterModal'; // ⚠️ path apne hisaab se adjust karna
        ...
        <nav className="mx-auto flex min-h-[70px] max-w-[1440px] items-center justify-between px-5 py-4 sm:px-8 lg:px-14">
          ...
          <div className="hidden items-center gap-4 md:flex">
            ...
            <button
              ...
              className="rounded-lg bg-[#1f5591] px-8 py-2 text-base font-medium text-white transition hover:bg-white hover:text-[#1f5591] border-2 hover:border-[#1f5591] border-[#1f5591]"
            >
              Register
            </button>

            {/* Nested button hata diya – AccessibilityButton khud button render karta hai */}
            <AccessibilityButton />
          </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="mt-2 flex flex-col gap-3 border-t border-slate-200 pt-4 sm:flex-row">
                ...
                <button
                  type="button"
                  onClick={() => {
                    setIsMenuOpen(false);   // pehle menu band
                    setRegisterOpen(true); // phir modal kholo
                  }}
